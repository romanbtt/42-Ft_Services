...
wp core install --allow-root --path=/var/www/wordpress/ --url=https://IP:5050 --title=ft_services --admin_user=admin --admin_password=password --admin_email=admin@ft_services.com
