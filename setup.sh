...
printf "\e[34;1m   7.  -- Stopping Minikube.\e[0m "
minikube stop &>/dev/null
printf "\e[32;1mDone\n\e[0m"

printf "\e[34;1m   8.  -- Deleting Minikube.\e[0m "
minikube delete &>/dev/null
rm -rf ~/.kube
rm -rf ~/.minikube
printf "\e[32;1mDone\n\e[0m"

printf "\e[34;1m   9.  -- Stopping all containers.\e[0m "
docker stop $(docker ps -a -q) &>/dev/null
printf "\e[32;1mDone\n\e[0m"

printf "\e[34;1m   10. -- Deleting all containers.\e[0m "
docker rm $(docker ps -a -q) &>/dev/null
printf "\e[32;1mDone\n\e[0m"

printf "\e[34;1m   11. -- Deleting all images.\e[0m "
docker rmi $(docker images -a -q) &>/dev/null
printf "\e[32;1mDone\n\e[0m"

printf "\e[34;1m   12. -- Installing the latest version of Minikube.\e[0m "
...
if [ $? -ne 0 ]; then printf "\033[1;31mError: Check error.log\033[0m\n" ; exit; fi
sed -i 's/MINIKUBE_IP/'$IP'/g' srcs/nginx/Dockerfile &>/dev/null
if [ $? -ne 0 ]; then printf "\033[1;31mError: Check error.log\033[0m\n" ; exit; fi
printf "\e[32;1mDone\n\e[0m"
...
function build_and_deploy()
{
	...
	docker build --quiet --network=host -t ft_services/$1 ./srcs/$1/ &>/dev/null
	if [ $? -ne 0 ]; then printf "\033[1;31mError: Check error.log\033[0m\n" ; exit; fi
	printf "\e[32;1mDone\n\e[0m"
	printf "\e[34;1m   $3.  -- Deploying $1.\e[0m "
	kubectl apply -f srcs/k8s/$1/ &>/dev/null
	if [ $? -ne 0 ]; then printf "\033[1;31mError: Check error.log\033[0m\n" ; exit; fi
	printf "\e[32;1mDone\n\e[0m"
}

printf "\e[34;1m   1.  -- Deploying metallb.\e[0m "
kubectl apply -f srcs/k8s/metallb/ &>/dev/null
if [ $? -ne 0 ]; then printf "\033[1;31mError: Check error.log\033[0m\n" ; exit; fi
printf "\e[32;1mDone\n\e[0m"
...
sed -i 's/'$IP'/MINIKUBE_IP/g' srcs/nginx/Dockerfile &>/dev/null
